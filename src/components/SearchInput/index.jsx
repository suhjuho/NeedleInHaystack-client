    ...
    <div className="relative flex flex-col gap-4 flex-grow max-w-[600px] items-center justify-center">
      <div className="flex flex-grow w-full">
        <input
          ...
          className="rounded-l-full bg-white border border-secondary-border shadow-inner shadow-secondary py-2 px-4 text-xl w-full focus:border-main outline-none"
          value={userInput}
